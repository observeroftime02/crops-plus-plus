...
//            r = 2250;
//        else if (crop.getCurrentSize() == 2 && (crop.isBlockBelow("blockQuicksilver") || !OreDictionary.doesOreNameExist("blockQuicksilver")))
//            r = 1750;
//        return r;
//    }
//
...
//            r = (crop.getCurrentSize() == 2 && (crop.isBlockBelow("blockQuicksilver") || !(OreDictionary.doesOreNameExist("blockQuicksilver"))));
//        return r;
//    }
//
//    @Override
