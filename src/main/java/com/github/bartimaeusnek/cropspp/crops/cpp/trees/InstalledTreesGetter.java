...
public class InstalledTreesGetter {
    ...
    public static void InstalledTreesGet() {
        ...
        for (int i = 0; i < SubItemNames.size(); i++) {
            ...
            if (!(SubItemNames.get(i).contains("Shimmerleaf") || SubItemNames.get(i).contains("Cinderpearl")) && !(SubItemNames.get(i).contains("Vishroom") || SubItemNames.get(i).contains("Ethereal Bloom"))) {
    ...
    private static List<ItemStack> synch_wood(List<ItemStack> subtypes1, List<ItemStack> subtypes2) {
        ...
        for (int i = 0; i < subtypes1.size(); i++) {
            for (int j = 0; j < subtypes2.size(); j++) {
                ...
                if (!synched && (subtypes2.get(j).getDisplayName().contains("Wood") && !subtypes2.get(j).getDisplayName().contains("Log"))) {
                ...
                } else if (!synched && (subtypes2.get(j).getDisplayName().contains("Log") && !subtypes2.get(j).getDisplayName().contains("Wood"))) {
