...
public class GTMachineRecipeLoader implements Runnable{
    ...
    public void run(){
    	...
    	GT_Values.RA.addMixerRecipe(new ItemStack(Items.sugar,32,0), new ItemStack(Items.dye,4,1), new ItemStack(Items.dye,4,11), new ItemStack(Items.dye,4,2), Materials.Water.getCells(4), null, new FluidStack(BppFluids.GHP,375), new FluidStack(FluidRegistry.getFluid("potion.alcopops"),4375), Materials.Empty.getCells(4), 10, 8);
    	...
    	GT_Values.RA.addMixerRecipe(new ItemStack(Items.sugar,8,0), new ItemStack(Items.dye,1,1), new ItemStack(Items.dye,1,11), new ItemStack(Items.dye,1,2), Materials.Water.getCells(1), null, new FluidStack(BppFluids.Korn,1000), new FluidStack(FluidRegistry.getFluid("potion.alcopops"),2000), Materials.Empty.getCells(1), 10, 8);
    	GT_Values.RA.addMixerRecipe(new ItemStack(Items.sugar,8,0), new ItemStack(Items.dye,1,1), new ItemStack(Items.dye,1,11), new ItemStack(Items.dye,1,2), Materials.Water.getCells(1), null, new FluidStack(BppFluids.DKorn,750), new FluidStack(FluidRegistry.getFluid("potion.alcopops"),1750), Materials.Empty.getCells(1), 10, 8);
    	...
    	GT_Values.RA.addMixerRecipe(new ItemStack(Items.sugar,8,0), OreDict.ISget("cropSpiceleaf"), OreDict.ISget("cropGinger"), new ItemStack(Items.dye,1,2), Materials.Water.getCells(1), null, new FluidStack(FluidRegistry.getFluid("potion.vodka"),4000), new FluidStack(BppFluids.njagi,5000), Materials.Empty.getCells(1), 10, 8);
